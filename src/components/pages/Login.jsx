...
//         try {
//             const response = await axios.post("http://localhost:2000/login", userData);
...
//                         />
//                     </Form.Item>
//                     <Button type="primary" htmlType="submit" className="w-full bg-blue-500 text-white p-2 rounded-md">Login</Button>
//                     <Link to='/register' className="block mt-4 text-center text-blue-500">CLICK HERE TO REGISTER</Link>
//                 </Form>
//             </div>
//         </div>
//     );
...
//     const handleSubmit = async () => {
//         try {
//             const response = await axios.post("http://localhost:2000/api/log", userData);
//             if (response.data.success) {
//                 toast.success(response.data.message);
//                 toast("Redirecting to home page");
//                 localStorage.setItem("token", response.data.data);
